...
const faqs = [
  ...
  { q: "Czy mogę samodzielnie edytować treści?", a: "Treści zmieniamy sami w ramach pakietu wsparcia — wystarczy przesłać nam nowe materiały, a my wprowadzimy je na stronę." },
        ...
        <div className="space-y-3">
          {faqs.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white rounded-2xl shadow-[var(--shadow-card)] hover-lift border border-[#e2e8f0] overflow-hidden"
              >
                <button
